...
class SceneMain extends Phaser.Scene {
  ...
  addPlatform(platformWidth, posX) {
    const posY = this.gameOptions.platformPositionY;
    ...
    this.nextPlatformDistance = Phaser.Math.Between(this.gameOptions.platformGapRange[0],
  ...
  update() {
    ...
    if (minDistance > this.nextPlatformDistance) {
      const nextPlatformWidth = Phaser.Math.Between(this.gameOptions.platformSizeRange[0],
